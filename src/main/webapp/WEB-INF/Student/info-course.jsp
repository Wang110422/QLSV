...
<head>
    ...
    <title>Course informations</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <table class="table text-center mt-4 ml-4 ml-4">
                <thead>
                <tr>
                    <th>Tên học phần</th>
                    <th>Mã học phần</th>
                ...
                <c:forEach var="course" items="${courses}">
                    <tr>
                        <td><a href="${pageContext.request.contextPath}/student/scores?courseId=${course.courseId}" class="course-name">${course.courseName}</a></td>
