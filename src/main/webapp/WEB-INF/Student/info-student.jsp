    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
                ...
                <div class="col">
                    <div class="row mb-2">
                        ...
                        <div class="col-8 mt-5">
                            <p class="font-weight-bold">Họ và tên: <br> ${student.name} </p>
                            <p class=""></p>
                        </div>
                    ...
                    <div class="row ">
                        <p class="col ml-4 font-weight-bold">Mã sinh viên: <br>${student.id} </p>
                        <p class="col font-weight-bold" >Khoa: ${student.department.departmentId}</p>
                        <p class="col font-weight-bold">Lớp: <br>${student.lop.classId}</p>
                    </div>
                </div>
            ...
            <table class="table mt-4">
                ...
                <tr class="">
                    <td>Giới tính</td>
                    <td class="text-primary font-weight-bold">${student.gender}</td>

                </tr>
                <tr class="">
                    <td>Quốc tịch</td>
                    <td class="text-primary font-weight-bold">Việt Nam</td>

                </tr>
                <tr class="">
                    <td>Ngày sinh</td>
                    <td class="text-primary font-weight-bold">${student.birthday}</td>

                </tr>
                <tr>
                    <td>Quê quán</td>
                    <td class="text-primary font-weight-bold">${student.hometown}</td>

                </tr>
                <tr>
                    <td>Số điện thoại</td>
                    <td class="text-primary font-weight-bold">${student.phonenumber}</td>
                </tr>
                </tbody>

            </table>
            <!-- /.container-fluid -->
            <a href="/student/infor/change" class="btn btn-danger col-2" >
