...
<body>
    ...
    <div class="content">
		...
		<a href="/student/infor/change" class="change" style = "display: block;background-color: red;color: white;font-size: 18px; padding: 12px 16px; border-radius: 4px; margin-top: 32px; width: 164px; position: relative; left: 624px; bottom: -119px;">
