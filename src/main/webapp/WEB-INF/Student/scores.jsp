...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <h4 class="text-center">Kết quả học phần </h4>
            <h5 class="text-center font-weight-bold mb-4 text-black"> ${courses.courseName} - ${courses.courseId}</h5>

            <table class="table mt-4 ml-4 ml-4">
                <thead>
                <tr>
                    <th>STT</th>
                    <th>Mã sinh viên</th>
