...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- End of Topbar -->
            <form class="ms-2" method="post" action = "/student/infor/change">
                <table class="table mt-4 ms-2">
                    <tr>
                        <td>Họ và tên:</td>
                        <td>${student.name}</td>
                    ...
                    <input hidden type="text" name="roles" value="${student.roles}">
                    <input hidden type="text" name="departmentId" value="${student.department != null ? student.department.departmentId : ''}">
                    <input hidden type="text" name="classId" value="${student.lop != null ? student.lop.classId : ''}">

                </table>
                <div class="infor-update-btn">
                    <input class="btn btn-primary" type="button" value="Làm mới" onclick="reset()">
