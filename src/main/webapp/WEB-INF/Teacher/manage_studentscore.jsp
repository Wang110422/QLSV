...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="content-heading" style="margin-left: 380px; margin-bottom:10px ;margin-top: 30px; font-size: 20px;">
            ...
            <form class="table-responsive" action = "${pageContext.request.contextPath}/teacher/course-score" method = "post">
                ...
                <input class="btn btn-primary col-md-6 offset-md-3" type="submit" value="Cập nhật điểm">
            </form>
            <!-- End of Topbar -->
            <!-- Begin Page Content -->
