...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- End of Topbar -->
            <form class="ml-2 table-responsive" name = "student" method="post">
                <table class="table ml-4 mt-4 table-bordered">
                    <tr>
                        <td>Mã sinh viên:</td>
                        <td><input name="id" type="text" value = "${student.id}"></td>
                    ...
                    <tr>
                        <td>Quê quán:</td>
                        <td><input type="text" name="hometown" value="${student.hometown}"></td>
                    </tr>
                    <tr>
                        <td>Số điện thoại:</td>
                    ...
                    <tr>
                        <td>Phân quyền:</td>
                        <td><input type="text" name="roles" value="${student.phonenumber}"></td>
                    </tr>
                    <tr>
                        <td>Mã lớp:</td>
                        <td><input type="text" name="classId" value="${student.phonenumber}"></td>
                    </tr>
                    <tr>
                        <td>Mã khoa:</td>
                        <td><input type="text" name="departmentId" value="${student.phonenumber}"></td>
                    </tr>
                </table>
                <div class="infor-update-btn">
                    <input class="btn-reset btn btn-primary  ml-4" type="button" value="Làm mới" onclick="reset()">
                    <input class="btn-submit btn btn-warning" type="submit" value="Thêm sinh viên mới">
                </div>
            </form>
            <!-- Begin Page Content -->
