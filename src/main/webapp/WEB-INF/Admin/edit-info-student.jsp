        ...
        <div id="content">
            ...
            <form class="ml-2 table-responsive" name = "student" method="post">
                <table class="table ml-4 mt-4 table-bordered">
                    ...
                    <tr>
                        <td>Phân quyền:</td>
                        <td><input type="text" name="roles" value="${student.roles}"></td>
                    </tr>
                    <tr>
                        <td>Mã lớp:</td>
                        <td><input type="text" name="classId" value="${student.lop.classId}"></td>
                    </tr>
                    <tr>
                        <td>Mã khoa:</td>
                        <td><input type="text" name="departmentId" value="${student.department.departmentId}"></td>
                    </tr>
                </table>
                <div class="infor-update-btn">
                    <input class="btn-reset btn btn-primary  ml-4" type="button" value="Làm mới" onclick="reset()">
                    <input class="btn-submit btn btn-warning" type="submit" value="Sửa sinh viên">
                </div>
            </form>
            <!-- Begin Page Content -->
