    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <table class="table mt-4">
                ...
                <tbody>
                <c:forEach var="feedback" items="${feedbacks}" varStatus="iterStat">
                    <tr>
                        <td>${feedback.feedBackId}</td>
                        <td>${feedback.content}</td>
                        <td>${feedback.status}</td>
                        <td>
                            <form action="${pageContext.request.contextPath}/admin/feedback-manager" method="post" style="display:inline;">
            ...
            <nav aria-label="..." style="">
                <ul class="pagination" style="justify-content: center;position: absolute; top: 606px; left: 727px;">
					<c:if test="${currentPage < 2 }">
					   <li class="page-item disabled"><a class="page-link" href="/admin/feedback-manager?page=${currentPage-1}">Trước</a></li>
					</c:if>
					<c:if test="${currentPage > 1 }">
						<li class="page-item"><a class="page-link" href="/admin/feedback-manager?page=${currentPage-1}">Trước</a></li>
					</c:if>

					<c:forEach begin="0" end="${totalPage-1}" varStatus="loop">
					   <li class="${(loop.index+1) eq currentPage ? 'page-item active' : 'page-item'}">
					      <a class="page-link" href="/admin/feedback-manager?page=${loop.index+1}">${loop.index+1}</a>
					   </li>
					</c:forEach>

					<c:if test="${currentPage == totalPage}">
					    <li class="page-item disabled"><a class="page-link"
					            href="/admin/feedback-manager?page=${currentPage+1}">Sau</a></li>
					</c:if>
					<c:if test="${currentPage < totalPage}">
