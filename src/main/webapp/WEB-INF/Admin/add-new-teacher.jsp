        ...
        <div id="content">
            ...
            <form class="ml-2 table-responsive" name = "student" method="post">
                <table class="table ml-4 mt-4 table-bordered">
                    <tr>
                        <td>Mã giảng viên:</td>
                        <td><input name="teacherId" type="text" value = "${teacher.teacherId}"></td>
                    </tr>
                    <tr>
                        <td>Họ và tên:</td>
                    ...
                    <tr>
                        <td>Phân quyền:</td>
                        <td><input type="text" name="role" value="${teacher.phonenumber}"></td>
                    </tr>
                    <tr>
                        <td>Mã khoa:</td>
                        <td><input type="text" name="departmentId" value="${teacher.phonenumber}"></td>
                    </tr>

                </table>
                <div class="infor-update-btn">
                    <input class="btn-reset btn btn-primary  ml-4" type="button" value="Làm mới" onclick="reset()">
                    <input class="btn-submit btn btn-warning" type="submit" value="Thêm giảng viên mới">
                </div>
            </form>
            <!-- Begin Page Content -->
